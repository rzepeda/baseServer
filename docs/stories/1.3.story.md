...
- `src/server.py` - Added Pydantic BaseModel serialization before JSON response (lines 10, 111-112)
- `tests/unit/test_youtube_tool.py` - Added MockSnippet and MockFetchedTranscript dataclasses, updated all mocks to use new API structure
